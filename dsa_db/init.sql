...
(2, 3, '発展課題1', 'doublylinked_list: doublylinked_list.o main_doublylinked_list.o', 'doublylinked_list.c', 'main_doublylinked_list.c', '/path/to/input', '/path/to/output', '/path/to/test/program'),
(3, 1, '基本課題1', 'open_addressing: open_addressing.o main_open_addressing.o', 'open_addressing.c', 'main_open_addressing.c', '/path/to/input', '/path/to/output', '/path/to/test/program'),
(4, 1, '基本課題1', "binarytree: binarytree.o main_binarytree.o", 'binarytree.c', 'main_binarytree.c', '/path/to/input', '/path/to/output', '/path/to/test/program'),
(4, 2, '基本課題2', 'binarysearchtree: binarysearchtree.o main_binarysearchtree.o', 'binarysearchtree.c', 'main_binarysearchtree.c', '/path/to/input', '/path/to/output', '/path/to/test/program'),
(4, 3, '発展課題1', 'binary_tree_mirror: binary_tree_mirror.o main_binary_tree_mirror.o', 'binary_tree_mirror.c', 'main_binary_tree_mirror.c', '/path/to/input', '/path/to/output', '/path/to/test/program'),
(4, 4, '発展課題2', 'bst_advanced: bst_advanced.o main_bst_advanced.o', 'bst_advanced.c', 'main_bst_advanced.c', '/path/to/input', '/path/to/output', '/path/to/test/program');
